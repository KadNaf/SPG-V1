          ...
          box(width = 8, solidHeader = TRUE, status = "primary",
            ...
            fluidRow(
              ...
              column(4,
                ...
                tags$p(style="color:#777;font-size:11px;",
                  "Genepop's own default (", tags$code("src/settings.cpp: mantelSeed=67144630"), "). Makes ",
                  tags$strong("this run"), " reproducible, but does not force the same permutation sequence as ",
                  "Genepop itself \u2014 R and C++ map the shared Mersenne-Twister stream to bounded random ",
                  "integers differently. See the info panel above."),
