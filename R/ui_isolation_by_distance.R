            ...
            fluidRow(
              column(6,
                tags$div(class="ibd-warn",
                  ...
                  tags$br(),
                  "Subsequent columns: any distance measures (genetic, geographic, temporal, ecological, categorical)",
                  tags$br(),
                  "Rows can be filtered to exclude specific pairs (e.g., non-contemporaneous)"
                )
              ),
              column(6,
