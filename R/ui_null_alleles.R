    ...
    fluidRow(
      box(
        ...
        tags$p(style = "color:#666;font-size:12px;",
          ...
          tags$br(), icon("info-circle"), " Files are saved as tab-delimited ", tags$strong(".txt"),
          " (not .csv), and download straight to your computer's usual Downloads location \u2014 just like ",
          "any file from a website \u2014 using the ", tags$strong(".txt"),
          " buttons below each result once the run has finished."),
